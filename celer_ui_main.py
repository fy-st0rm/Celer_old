...
class main_ui:
	def __init__(self, user, network):
		...
		self.serverCreatebutton = tk.Button(command = self.createServer, image = self.add_server_button_normal, borderwidth = 0, relief='sunken', bg = '#212325', activebackground="#212325", highlightthickness=0, bd=0)
		self.serverJoinbutton = tk.Button(command = self.joinServer, image = self.join_server_button_normal, borderwidth = 0, relief='sunken', bg = '#212325', activebackground="#212325", highlightthickness=0, bd=0)
